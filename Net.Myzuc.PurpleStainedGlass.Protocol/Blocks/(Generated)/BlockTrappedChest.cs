...
{
    public sealed class BlockTrappedChest : Block
    {
        ...
        public override int BlockId => 9119 + (Waterlogged ? 0 : 1) + (int)Type * 2 + (int)Facing * 6;
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 9119]];
        ...
        public override BlockTrappedChest Clone()
        {
            return new()
            {
