...
{
    public sealed class BlockHornCoralWallFan : Block
    {
        ...
        public override int BlockId => 12925 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockHornCoralWallFan Clone()
        {
            return new()
            {
