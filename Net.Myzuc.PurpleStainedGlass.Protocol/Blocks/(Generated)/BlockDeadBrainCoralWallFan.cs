...
{
    public sealed class BlockDeadBrainCoralWallFan : Block
    {
        ...
        public override int BlockId => 12861 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockDeadBrainCoralWallFan Clone()
        {
            return new()
            {
