...
{
    public sealed class BlockDeadFireCoralWallFan : Block
    {
        ...
        public override int BlockId => 12877 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockDeadFireCoralWallFan Clone()
        {
            return new()
            {
