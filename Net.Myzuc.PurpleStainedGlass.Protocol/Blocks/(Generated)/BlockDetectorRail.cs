...
{
    public sealed class BlockDetectorRail : Block
    {
        ...
        public override int BlockId => 1968 + (Waterlogged ? 0 : 1) + (int)Shape * 2 + (Powered ? 0 : 12);
        ...
        public override BlockDetectorRail Clone()
        {
            return new()
            {
