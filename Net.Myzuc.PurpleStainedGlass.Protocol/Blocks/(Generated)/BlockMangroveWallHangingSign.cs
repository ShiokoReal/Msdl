...
{
    public sealed class BlockMangroveWallHangingSign : Block
    {
        ...
        public override int BlockId => 5594 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 5594]];
        ...
        public override BlockMangroveWallHangingSign Clone()
        {
            return new()
            {
