...
{
    public sealed class BlockBrainCoralWallFan : Block
    {
        ...
        public override int BlockId => 12901 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockBrainCoralWallFan Clone()
        {
            return new()
            {
