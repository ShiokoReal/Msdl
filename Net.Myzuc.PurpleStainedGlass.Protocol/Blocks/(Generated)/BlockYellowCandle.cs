...
{
    public sealed class BlockYellowCandle : Block
    {
        ...
        public override int BlockId => 20805 + (Waterlogged ? 0 : 1) + (Lit ? 0 : 2) + Candles * 4;
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 20805]];
        ...
        public override BlockYellowCandle Clone()
        {
            return new()
            {
