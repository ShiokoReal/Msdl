...
{
    public sealed class BlockBubbleCoralWallFan : Block
    {
        ...
        public override int BlockId => 12909 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockBubbleCoralWallFan Clone()
        {
            return new()
            {
