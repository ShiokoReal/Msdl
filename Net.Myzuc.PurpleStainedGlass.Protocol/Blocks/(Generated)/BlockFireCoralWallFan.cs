...
{
    public sealed class BlockFireCoralWallFan : Block
    {
        ...
        public override int BlockId => 12917 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockFireCoralWallFan Clone()
        {
            return new()
            {
