...
{
    public sealed class BlockCutCopperStairs : Block
    {
        ...
        public override int BlockId => 23196 + (Waterlogged ? 0 : 1) + (int)Shape * 2 + (int)Half * 10 + (int)Facing * 20;
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 23196]];
        ...
        public override BlockCutCopperStairs Clone()
        {
            return new()
            {
