...
{
    public sealed class BlockCyanStainedGlassPane : Block
    {
        ...
        public override int BlockId => 9660 + (West ? 0 : 1) + (Waterlogged ? 0 : 2) + (South ? 0 : 4) + (North ? 0 : 8) + (East ? 0 : 16);
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 9660]];
        ...
        public override BlockCyanStainedGlassPane Clone()
        {
            return new()
            {
                West = West,
