...
{
    public sealed class BlockDeadTubeCoralWallFan : Block
    {
        ...
        public override int BlockId => 12853 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockDeadTubeCoralWallFan Clone()
        {
            return new()
            {
