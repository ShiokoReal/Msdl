...
{
    public sealed class BlockLightGrayBed : Block
    {
        ...
        public override int BlockId => 1816 + (int)Part * 1 + (Occupied ? 0 : 2) + (int)Facing * 4;
        public override int LiquidId => 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 1816]];
        ...
        public override BlockLightGrayBed Clone()
        {
            return new()
            {
                Part = Part,
