...
{
    public sealed class BlockCampfire : Block
    {
        ...
        public override int BlockId => 18511 + (Waterlogged ? 0 : 1) + (SignalFire ? 0 : 2) + (Lit ? 0 : 4) + (int)Facing * 8;
        ...
        public override BlockCampfire Clone()
        {
            return new()
            {
