...
{
    public sealed class BlockLantern : Block
    {
        ...
        public override int BlockId => 18503 + (Waterlogged ? 0 : 1) + (Hanging ? 0 : 2);
        public override int LiquidId => Waterlogged ? 1 : 0;
        public override int LightEmission => 15;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 18503]];
        ...
        public override BlockLantern Clone()
        {
            return new()
            {
