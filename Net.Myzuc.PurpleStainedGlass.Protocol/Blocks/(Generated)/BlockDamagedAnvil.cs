...
{
    public sealed class BlockDamagedAnvil : Block
    {
        ...
        public override int BlockId => 9115 + (int)Facing * 1;
        public override int LiquidId => 0;
        public override int LightEmission => 0;
        public override int LightFilter => 0;
        public override (double xa, double ya, double za, double xb, double yb, double zb)[] Collisions => [.. InternalCollisions[BlockId - 9115]];
        public EnumFacing Facing = EnumFacing.North;
        public BlockDamagedAnvil()
        {
            
        }
        public override BlockDamagedAnvil Clone()
        {
            return new()
            {
                Facing = Facing
