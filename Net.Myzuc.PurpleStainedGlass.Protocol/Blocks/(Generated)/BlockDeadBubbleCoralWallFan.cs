...
{
    public sealed class BlockDeadBubbleCoralWallFan : Block
    {
        ...
        public override int BlockId => 12869 + (Waterlogged ? 0 : 1) + (int)Facing * 2;
        ...
        public override BlockDeadBubbleCoralWallFan Clone()
        {
            return new()
            {
